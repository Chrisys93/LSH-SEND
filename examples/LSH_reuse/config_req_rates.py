...
RESULTS_PATH = ['/req_rates/Repo/no_reuse/no_orchestration', '/req_rates/Repo/reuse/no_orchestration']#, '/Queue-based/reuse/orchestration',
...
NETWORK_REQUEST_RATE = [2000, 4000, 5000]
