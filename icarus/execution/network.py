...
class NetworkModel(object):
    ...
    def __init__(self, topology, cache_policy, repo_policy, sched_policy, n_services, rate, seed=4353, shortest_path=None):
        ...
        service_time_min = 0.009  # used to be 0.10 # used to be 0.001, 0.03 for Multi, 0.01 for MNIST
        service_time_max = 0.012 # used to be 0.10  # used to be 0.1, 0.08 for Multi, 0.015 for MNIST
        # delay_min = 0.005
